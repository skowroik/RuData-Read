...
void readRuData( string inFile, string outFile, ULong64_t nEvents ){
  ...
  theTree->Branch( "iMax", &derivMax, "derivMax/D" );
  theTree->Branch( "riseTime", &riseTime, "riseTime/D" );
  theTree->Branch( "CFD", &CFD, "CFD[100]/F" );
  theTree->Branch( "CFDzero", &CFDzero, "CFDzero/F" ); 
